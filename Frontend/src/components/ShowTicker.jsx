...
function ShowTicker(props) {
  ...
  return (
    <>
      ...
      <h2 className='ms-5 mt-5'>Hora de entrada: {new Date(props.data.hora_input).toUTCString()}</h2>
      <h2 className='ms-5 mt-5'>Hora de salida: {new Date(Date.now()).toUTCString()}</h2>
